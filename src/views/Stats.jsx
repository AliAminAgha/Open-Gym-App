...
export default function Stats() {
  ...
  return <>
    ...
    {hasProfile(S) && (() => {
      ...
      const cals = calorieSuggestion(S.profile, currentWeightKg(S))
      return (
        <div className="card">
          ...
          {cals && (
            <div className="small dim" style={{ marginTop: 12 }}>
              {t('Estimated intake')}: {formatKcalRange(cals.low, cals.high)} · {t('Estimates only')}
            </div>
          )}
        </div>
      )
    ...
    <div className="tiles">
      ...
      <div className="tile"><div className="l"><Icon name="flame" />{t('Week streak')}</div><div className="v">{streak}</div></div>
